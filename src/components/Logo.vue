<template>
<svg id="Calque_2" fill="url(#linear-gradient)"
data-name="Calque 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 372.75 585.6">
  <defs>
    <linearGradient id="linear-gradient" gradientTransform="rotate(-60)" x1="186.37" y1="0" x2="186.37" y2="585.6" gradientUnits="userSpaceOnUse">
  <stop offset="0" stop-color="#5A069B"/>
